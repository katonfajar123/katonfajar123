...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Internal System · CRM · Property Pipeline</strong></p>
      <p>Centralized lead management and operational workflows built around the needs of a real-estate business.</p>
      <code>Laravel</code> <code>CRM</code> <code>Automation</code>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://katonfajar.com/id/proyek">InixCert</a></h3>
      <p><strong>Digital Certificate Management</strong></p>
      <p>A Laravel-based certificate management workflow designed to make certificate publishing and administration more structured.</p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Property Platform · Content & Data</strong></p>
      <p>A property portal ecosystem combining listings, structured area content, operational data, and publishing workflows.</p>
    ...
    <td width="50%" valign="top">
      ...
      <p><strong>Process Automation · Integrations</strong></p>
      <p>Practical automation for validation, system integration, repetitive work reduction, and cleaner operational handoffs.</p>
